...
const Sidebar = () => {
    ...
    const { messages, users, selectedUser, getUsers, setMessages, sendMessage, setSelectedUser, unseenMessages, setUnseenMessages } = useContext(ChatContext);
    ...
    return (
        <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-hideen text-white ${selectedUser ? 'max-md:hidden' : ''}`}>
            <div className='pb-5'>
