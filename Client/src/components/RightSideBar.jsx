...
const RightSideBar = () => {
  ...
  // GET ALL THE IMAGES FROM THE MESSAGES AND STORE IN THE STATE 
  useEffect(()=>{
    setMsgImages(
  ...
  return selectedUser && (
    <div className={`text-white bg-[#8185B2]/10 w-full relative overflow-y-auto ${selectedUser ? "max-md:hidden" : ""}`}>
      <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
        <img src={selectedUser?.profilePic || assets.avatar_icon} alt='' className=' rounded-full aspect-[1/1] w-20' />
